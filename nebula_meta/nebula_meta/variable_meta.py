...
from .property_mapping import ConstantPropertyMapping, DirectPropertyMapping, ConcatPropertyMapping
...
class VariableMeta(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._chinese_name = text(kwargs.get("chineseName", ""))
        self._module = text(kwargs["module"])
        self._type = text(kwargs["type"])
        self._dimension = text(kwargs["dimension"])
        self._value_type = text(kwargs["valueType"])
